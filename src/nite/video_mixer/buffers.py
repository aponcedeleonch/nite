...
class TimedSampleBuffer(Buffer):
    ...
    def _add_sample_to_buffer(self, sample: np.ndarray) -> None:
        ...
        self.buffer[current_samples:current_samples + samples_to_add, -1] = sample[:samples_to_add]
...
class SampleBuffer(Buffer):
    ...
    def __init__(self, max_buffer_size: Optional[int] = None, min_buffer_size: int = 0, num_samples_remove: int = 0) -> None:
        super().__init__()
