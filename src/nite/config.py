...
VIDEO_LOCATION = os.getenv('VIDEO_LOCATION', str(Path(__file__).parent.absolute() / 'video_mixer'))
...
# These values were found to be the most suitable for the test tracks. See experiments notebook for more details.
